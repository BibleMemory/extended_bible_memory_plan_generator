// KJV versification data for all 66 books of the Protestant Bible.
// chapters[i] is the verse count of chapter i+1.
// Source: standard KJV chapter/verse counts (whole-Bible total 31,102 verses).
export const BOOKS = [
...
export function totalVerses(book) {
